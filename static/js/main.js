        ...
        function _initTab(name) {
            ...
            if (name === 'upload') _tryInit('initUploadTab', 10);
        ...
        var _tabLabels = { dashboard: 'Dashboard', upload: 'Upload Data', quality: 'Quality Reports', analysis: 'Comparative Analysis', clinical: 'Clinical Intelligence', outliers: 'Outliers', alerts: 'Alerts', 'indicator-tree': 'Indicator Tree', 'rules-manager': 'Rules Manager', 'root-cause': 'Root Cause', audit: 'Audit Log', admin: 'System Control', settings: 'System Settings', 'smart-analytics': 'Smart Analytics' };
        var _tabIcons = { dashboard: '📊', upload: '📤', quality: '⭐', analysis: '📈', clinical: '🩺', outliers: '⚠', alerts: '🔔', 'indicator-tree': '🌳', 'rules-manager': '📝', 'root-cause': '🔍', audit: '📋', admin: '🛡', settings: '⚙', 'smart-analytics': '🧠' };
