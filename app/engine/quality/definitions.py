...
RULE_CATALOG = [
    ...
    {"code": "R024", "name": "Primary + Secondary Severe PPH = Postpartum Hemorrhage", "type": "CLINICAL", "severity": "MEDIUM"},
    {"code": "R025", "name": "Placental Abruption + Previa/Accreta = Antepartum Hemorrhage", "type": "CLINICAL", "severity": "MEDIUM"},
    {"code": "R026", "name": "Ectopic + Abortion Bleeding + Molar = Early Pregnancy Hemorrhage", "type": "CLINICAL", "severity": "MEDIUM"},
